...
> **文档职责：只维护可脱离本项目复用的 Agent 概念、比较框架和取舍方法。** 项目当前事实与完整回答统一查 [10 项目设计 FAQ](10-面试问答与项目讲法.md)，架构和代码分别查 [24 项目全景](24-项目全景与心智模型.md) 与 [25 代码导读](25-代码导读与模块地图.md)。文中的 sandboxd 只作为概念落地示例，不作为第二套项目答案。
...
本篇讲定义，不再维护一套“项目速答”。需要回答 sandboxd 的具体追问时，按下面映射回唯一答案源：

| 通用主题 | 项目完整答案 |
|---|---|
| ReAct、手写循环、steer/follow-up/cancel | [10 §7 Agent Runtime 高频问答](10-面试问答与项目讲法.md#7-agent-runtime-高频问答) |
| Tool Schema、Plugin、Prompt Injection | [10 §8 Agent 安全与工具问答](10-面试问答与项目讲法.md#8-agent-安全与工具问答) |
| Session、Task、Sandbox 身份 | [24 §5 五类身份](24-项目全景与心智模型.md#5-五类身份不要混) |
| Replay、Live 和真实安全证据 | [10 Q27](10-面试问答与项目讲法.md#q27replay-与-live-分别证明什么) |
| 文件 Workspace 与外部写操作 | [10 Q30](10-面试问答与项目讲法.md#q30文件工具会修改生产系统吗) |
| 生产化差距 | [10 §10 生产化差距](10-面试问答与项目讲法.md#10-生产化差距) |
