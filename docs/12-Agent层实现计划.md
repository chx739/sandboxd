...
Agentd 使用 AGENTD_LISTEN、AGENTD_TOKEN、AGENTD_ALERT_TOKEN、AGENTD_PROMETHEUS_URL、AGENTD_SANDBOXD_URL、AGENTD_LLM_MODE、AGENTD_LLM_BASE_URL、AGENTD_LLM_MODEL、AGENTD_LLM_API_KEY、AGENTD_REPLAY_FILE。sandboxd 继续使用 SANDBOXD_TOKEN 和 SANDBOXD_OPERATOR_TOKEN。
